    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Motion.label
          ...
          className={`cursor-pointer rounded-2xl border-2 p-4 transition ${deliveryType === "instant"
        ...
        <Motion.label
          whileHover={{ scale: 1.02 }}
          className={`cursor-pointer rounded-2xl border-2 p-4 transition ${deliveryType === "scheduled"
              ? "border-green-500 bg-white shadow-lg"
              : "border-slate-200 bg-white hover:border-green-300"
            }`}
        >
